...
class DegreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create degree" do
    assert_difference('Degree.count') do
      post degrees_url, params: { degree: { concentration: @degree.concentration, degree_reqs_id: @degree.degree_reqs_id, major: @degree.major } }
    end
  ...
  test "should update degree" do
    patch degree_url(@degree), params: { degree: { concentration: @degree.concentration, degree_reqs_id: @degree.degree_reqs_id, major: @degree.major } }
