...
class PathsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create path" do
    assert_difference('Path.count') do
      post paths_url, params: { path: { course_load: @path.course_load, degree_id: @path.degree_id, in_class: @path.in_class, online: @path.online, start_quarter: @path.start_quarter } }
    end
  ...
  test "should update path" do
    patch path_url(@path), params: { path: { course_load: @path.course_load, degree_id: @path.degree_id, in_class: @path.in_class, online: @path.online, start_quarter: @path.start_quarter } }
